...
class NewsAddN{
	...
	/*recent*/
	  ...
	  /*interview*/
	   public function getAllInterviewNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1'AND category_id = '1' ORDER BY news_id DESC  LIMIT 3";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  /*government*/
	   public function getAllgovmentNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1'AND category_id = '1' ORDER BY news_id DESC  LIMIT 1";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  /*oposite*/
	  ...
	  public function getSuperTopNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' ORDER BY news_id DESC  LIMIT 1";
	  	$result = $this->db->select($query);
	  	return $result;
	  }

	  public function getNationalNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1'AND category_id = '1' ORDER BY news_id DESC  LIMIT 6";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  ...
	  public function getAllSportsNews2nd(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1'AND subcategory_id = '1' ORDER BY news_id DESC  LIMIT 1";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  ...
	  public function getTopPoliticalNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND top_news = '1' AND category_id = '1' ORDER BY news_id DESC  LIMIT 1";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  ...
	  public function getAllEconomicalNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1'AND category_id = '1' ORDER BY news_id DESC  LIMIT 4";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	 ...
	 /* get dhalywood top news*/
	  ...
	  public function getFacebookKothonAllNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '1' ORDER BY news_id DESC  LIMIT 3";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  /* get facebook kothon top news*/
	  ...
	  public function getAllsahittoNewsinner(){
	  	...
	  	$result = $this->db->select($query);
	  	return $result;
	  }public function getAllsahittoNewss(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '2' ORDER BY news_id DESC  LIMIT 10";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  ...
	  /*get all bicitrokhobor news  for main page*/
	   public function getAllbicitroNewsformain(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1'AND category_id = '1' ORDER BY news_id DESC  LIMIT 2";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  ...
	  public function getAllITechnologyNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1'AND subcategory_id = '2' ORDER BY news_id DESC  LIMIT 6";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	 ...
	 public function getAllNariNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '1' ORDER BY news_id DESC  LIMIT 5";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
    ...
    /*get top feni news*/
     ...
     /*get top brahmonbaria news*/
	  ...
	  /*probondho 2nd part  news*/
	  public function getallprobondhoNews2ndpart(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '17' ORDER BY news_id DESC  LIMIT 6,3";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  /*chora news*/
	  public function getallChoraNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '18' ORDER BY news_id DESC  LIMIT 3";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  /*chora 2ndnd part news*/
	  public function getallChoraNewsfor2ndpart(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '18' ORDER BY news_id DESC  LIMIT 3,4";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  /*kobita news*/
	  public function getallKobitaNews(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '19' ORDER BY news_id DESC  LIMIT 2";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
	  /*kobita news*/
	  public function getallKobitaNews2ndpart(){
	  	$query = "SELECT * FROM tbl_newses WHERE status = '1' AND subcategory_id = '19' ORDER BY news_id DESC  LIMIT 2,3";
	  	$result = $this->db->select($query);
	  	return $result;
	  }
